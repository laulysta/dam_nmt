...
def load_data(batch_size=128):
    ...
    train = HomogenousData(batch_size, train_path_trg, train_path_src, use_infinite_loop=False)
    valid = HomogenousData(batch_size, valid_path_trg, valid_path_src, use_infinite_loop=False)
    test = HomogenousData(batch_size, test_path_trg, test_path_src, use_infinite_loop=False)
